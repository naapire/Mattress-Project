...
function Footer() {
  return (
    <div>
      <section className="bg-[#f40000] lg:grid grid-flow-col grid-cols-3 gap-10 px-10 py-7 text-white ">
        <div className="text">
      ...
      <div className="bg-gray-700 border-2 border-white border-x-0 text-center py-5  font-bold text-white" ><p className="mx-2">© 2024 MATTRESS HOME Developed By <span className="text-blue-500">CHARLES OWUSU BIH</span></p></div>
    </div>
  );
}
